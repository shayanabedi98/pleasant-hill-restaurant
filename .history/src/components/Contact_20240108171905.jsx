...
const Contact = () => {
  ...
  const [selected, setSelected] = useState({text: "Make a reservation", active: true})
  ...
  return (
    <div className="contact">
      ...
      <DatePicker
        {selected.active && placeholderText={selected.text}}
        selected={startDate}
        ...
        dateFormat="Pp"
      />
      <button id="book">Book Reservation</button>
