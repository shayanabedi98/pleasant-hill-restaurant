...
const Contact = () => {
  ...
  return (
    <div className="contact">
      ...
      {!booked && (
        <div>
          <input type="text" onChange={(e) => setInfo({...info, name: e.target.value})} value={info.name} className="info" required placeholder="Name"/>
          <input type="email" onChange={(e) => setInfo({...info, email: e.target.value})} value={info.email} className="info" required placeholder="Email"/>
          <DatePicker
