...
const Contact = () => {
  ...
  useEffect(handleClickDate(), [booked])
  ...
  return (
    <div className="contact">
      ...
      <DatePicker
        ...
        dateFormat="Pp"
      />
      <button onClick={handleClickDate} id="book">Book Reservation</button>
      {booked && <h4>Your reservation has been booked for, {startDate.toLocaleDateString()} at {startDate.toLocaleTimeString()}</h4>}
