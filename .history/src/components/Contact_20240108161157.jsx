  ...
  return (
    <div className="contact">
      ...
      <p>
        ...
        <br />
        <span>Address:</span> 123 Gourmet Lane,
        <br />
        <span>Phone:</span> (123) 456-7890
        <br />
        <span>Email:</span> contact@pleasanthilldining.com 
        <br />
        <span>Reservations:</span> For table reservations,
        please call us or book online. 
        <br />
        <span>Opening Hours:</span> 
        <br />
        Lunch:
        12:00 PM - 3:00 PM (Mon-Sun) 
        <br />
        Dinner: 6:00 PM - 11:00 PM (Mon-Sun) 
        <br />
      </p>
      <DatePicker
        selected={startDate}
